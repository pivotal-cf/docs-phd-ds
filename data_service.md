...
For more information about the the Apps Manager, see [Getting Started with the Apps Manager](../pivotalcf/console/dev-console.html).

##CF Command Line

To create a Pivotal HD cluster instance:

1. Install the CF Command Line Interface.  For more information on the CF Command Line Interface, see [Installing the CF CLI](../pivotalcf/cf-cli/install-go-cli.html).

2. Log in to PCF using the CF CLI. See [Getting Started with the CF CLI](../pivotalcf/cf-cli/getting-started.html
...
1. Log in to PCF using the CF CLI. See [Getting Started with the CF CLI](../pivotalcf/cf-cli/getting-started.html).
...
1. Log in to CF using the CF CLI. See [Getting Started with the CF CLI](../pivotalcf/cf-cli/getting-started.html).
