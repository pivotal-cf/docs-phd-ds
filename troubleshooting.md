...
<p>Information required to access the Pivotal HD Service Broker is displayed in Pivotal Cloud Foundry Ops Manager, which also displays the status of the virtual machine and enables you to download its log files in the same way as for other PCF tiles. </p>
