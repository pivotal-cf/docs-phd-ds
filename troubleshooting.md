...
<p>Information required to access the Pivotal HD Service Broker is displayed in [Pivotal Cloud Foundry&reg;](https://network.pivotal.io/products/pivotal-cf) (PCF) Ops Manager, which also displays the status of the virtual machine and enables you to download its log files in the same way as for other PCF tiles. </p>
